...
export default class Estudiantes extends Component {
    ...
    handleDelete(estudiante)
    {
        ...
        console.log("pasó por Porfesor.js handleDelete, estudiante "+estudiante.identificacion);
    ...
    {
        console.log("pasó por Porfesor.js handleEditCancel, estudiante "+estudiante.identificacion);
        this.setState(prevState => {
    ...
    {
        //console.log("pasó por Porfesor.js handleEditChange, estudiante "+estudiante.identificacion);
        this.setState(prevState => ({
            isEditing: {...prevState.isEditing, [estudiante._id]: estudiante}
        }));
    }
    ...
    {
        //console.log("pasó por Porfesor.js handleEditSave, estudiante "+estudiante.identificacion);
    ...
    handleImageAdded(estudiante)
    {
        ...
        this.setState(prevState => {
            ...
            const estudiantes = prevState.estudiantes;
            const pos = estudiantes.findIndex(p  => p._id ===  estudiantes._id);
                ...
                <table className="table table-bordered table-striped table-hover" >
                    ...
                    <tbody>
                        {this.state.estudiantes.map((estudiante) => 
                            ...
                            !this.state.isEditing[estudiante._id] ?
                            <Estudiante 
                            ...
                            :
                            <EditEstudiante 
                                estudiante={this.state.isEditing[estudiante._id]} 
